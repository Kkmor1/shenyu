...
package org.apache.shenyu.springboot.starter.plugin.headerblacklist;

import org.apache.shenyu.plugin.api.ShenyuPlugin;
import org.apache.shenyu.plugin.base.handler.PluginDataHandler;
import org.apache.shenyu.plugin.headerblacklist.HeaderBlacklistPlugin;
 ...
 */
@Configuration
@ConditionalOnProperty(value = {"shenyu.plugins.header-blacklist.enabled"}, havingValue = "true", matchIfMissing = true)
public class HeaderBlacklistPluginConfiguration {
     ...
     */
    @Bean
    public ShenyuPlugin headerBlacklistPlugin() {
