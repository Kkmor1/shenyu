...
public class HeaderBlacklistPluginConfigurationTest {
    ...
    public void testHeaderBlacklistPlugin() {
        new ApplicationContextRunner()
                ...
                .withBean(HeaderBlacklistPluginConfigurationTest.class)
                .withPropertyValues("debug=true")
                .run(context -> {
                    ShenyuPlugin plugin = context.getBean("headerBlacklistPlugin", ShenyuPlugin.class);
                    assertNotNull(plugin);
                    assertThat(plugin.named()).isEqualTo("header-blacklist");
                    assertThat(plugin.getOrder()).isEqualTo(10);
                });
    }
    ...
    public void testHeaderBlacklistPluginDataHandler() {
        new ApplicationContextRunner()
                ...
                .run(context -> {
                    ...
                    assertThat(handler.pluginNamed()).isEqualTo("header-blacklist");
                });
    }
}
