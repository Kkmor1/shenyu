...
public class HeaderBlacklistPluginDataHandler implements PluginDataHandler {
    ...
    /**
     * The cached handle for header blacklist rules.
     */
    ...
    public void handlerRule(final RuleData ruleData) {
        Optional.ofNullable(ruleData.getHandle()).ifPresent(s -> {
            HeaderBlacklistRuleHandle headerBlacklistRuleHandle = GsonUtils.getInstance().fromJson(s, HeaderBlacklistRuleHandle.class);
            CACHED_HANDLE.get().cachedHandle(CacheKeyUtils.INST.getKey(ruleData), headerBlacklistRuleHandle);
        });
    }
