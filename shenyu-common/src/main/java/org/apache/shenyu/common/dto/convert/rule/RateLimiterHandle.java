...
public class RateLimiterHandle {
     ...
     * is fallbackToLocal.
     *
     * @return fallbackToLocal boolean
     */
    ...
    @Override
    public int hashCode() {
        return Objects.hash(algorithmName, replenishRate, burstCapacity, requestCount, loged,
                keyResolverName, fallbackToLocal, localRate, localBurst);
    }
